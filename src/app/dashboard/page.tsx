    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-xl md:text-2xl font-bold text-brand-textDark">Dashboard</h1>
          ...
          <Link
            href="/invoices/new"
            className="inline-flex items-center justify-center gap-2 bg-brand-accent text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-pink-700 transition-colors shadow-sm shadow-brand-accent/25 w-full sm:w-auto"
          >
